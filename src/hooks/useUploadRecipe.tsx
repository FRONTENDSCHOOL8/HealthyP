    ...
    async function getNutritionData() {
      const completion = await openai.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `${ingredientData}, ${seasoningData} give me the nutritional information for these ingredients in a JSON format without any whitespaces. Make sure to add the unit for each data.`,
          },
        ],
