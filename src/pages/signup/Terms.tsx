...
import {
  isCheckedOptionsAtom,
  isCheckedRequiredAtom,
} from '@/components/term/atomTerm';
import {
  EMAIL_SERVICE,
  FIRST_MAIN,
  SECOND_MAIN,
  TERM_OF_USE,
} from '@/components/term/termData';
...
export function Terms() {
  ...
  const [isCheckedRequired, setIsCheckedRequired] = useAtom(
    isCheckedRequiredAtom
  );
      ...
      <div role="group" className="mx-14pxr mt-18pxr pb-140pxr mb-198pxr">
        ...
        <div className="flex flex-col gap-24pxr">
          ...
          <Term
            ...
            required={true}
            mainContent={FIRST_MAIN}
            subContent={TERM_OF_USE}
          />
          <Term
            name="checkedOptions"
            required={false}
            mainContent={SECOND_MAIN}
            subContent={EMAIL_SERVICE}
          />
        </div>
      </div>
